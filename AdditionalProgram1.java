public class AdditionalProgram1 {
	public static void main (String args[]) {
		...
		String line="Welcome "+"to "+"string "+"functions";
		...
		//replace
		System.out.println("Replacing h with k in hello:"+"hello".replace('l','k'));
		//upper and lower case
		System.out.println("converting 'hello' to uppercase:"+"hello".toUpperCase());
		System.out.println("converting 'world' to lower case:"+"WORLD".toLowerCase());
		//additional string methods
		System.out.println("Unicode value of 'a'is:"+"ram".codePointAt(1));
		System.out.println("'java lab' contains la?:"+"java lab".contains("la"));
		System.out.println(String.format("string %s","format"));
