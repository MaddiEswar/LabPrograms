public class AdditionalProgram2 {
	public static void main (String args [])
	{
		...
		System.out.println (s);
		s.setCharAt (1, 'g');
		System.out.println ("replacing a character 'e' with 'g' in 'Hel'" + s);
		// append
		...
		// replace
		StringBuffer z = new StringBuffer ("position");
		System.out.println ("index position:" + z.indexOf ("i"));
		System.out.println ("last index position:" + z.lastIndexOf ("i"));
